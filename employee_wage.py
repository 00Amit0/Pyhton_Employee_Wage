...
class Employee:
    ...
    def attendance(self, check):
        try:
            if check == 0:
                ...
                # print(" Employee is present ; full-timer")
            elif check == 1:
                daily_working_hour = 4
                # print(" Employee is present ; part-timer ")
            else:
                daily_working_hour = 0
                # print(" Employee is absent ")
            return daily_working_hour
    ...
    def emp_dict(self):
        return {"Name": self.name, "Total_wage": self.calculate_wage()}
